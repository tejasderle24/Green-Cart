        ...
        <div className="mt-12">
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="mt-6">
                        <p className="text-gray-500/70 line-through">MRP: <FormatPrice price={product.price} /></p>
                        <p className="text-2xl font-medium">MRP: <FormatPrice price={product.offerPrice} /></p>
